...
#define Debug_log(fmt,...)      {printf("%s log    -[fun:%-25.25s line:%05d:	]:",Print_TAG,__FUNCTION__,__LINE__);printf(fmt,##__VA_ARGS__);}
#define Debug_error(fmt,...)    {printf("%s error  -[fun:%-25.25s line:%05d:	]:",Print_TAG,__FUNCTION__,__LINE__);printf(fmt,##__VA_ARGS__);}
#define Debug_warning(fmt,...)  {printf("%s warning-[fun:%-25.25s line:%05d:	]:",Print_TAG,__FUNCTION__,__LINE__);printf(fmt,##__VA_ARGS__);}
